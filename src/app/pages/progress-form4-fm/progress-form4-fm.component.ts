...
@Component({
  ...
  templateUrl: './progress-form4-fm.component.html',
  styleUrls: ['./progress-form4-fm.component.scss', '../pagesStyle.css']
})
export class ProgressForm4FmComponent implements OnInit {
  ...
  showDebug() {
    console.log(this.analysisForm.controls);
