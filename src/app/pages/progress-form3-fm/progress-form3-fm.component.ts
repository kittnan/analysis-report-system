...
@Component({
  ...
  templateUrl: './progress-form3-fm.component.html',
  styleUrls: ['./progress-form3-fm.component.scss', '../pagesStyle.css']
})
export class ProgressForm3FmComponent implements OnInit {
